...
public class DispenseDrug implements UseCase<Void, SubmitDispenseDto> {
    ...
    @Override
    public Void execute(SubmitDispenseDto submitDispenseDto) throws InsufficientAmountException {
        ...
        dispensaryService.updateDrugAmount(drug.getDrugId(),
                drug.getStockAmount() - submitDispenseDto.getAmount());
